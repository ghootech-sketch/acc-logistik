  ...
  return (
    <section className="section-padding">
      <div className="container-page">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">{services.map((service, index) => <ScrollReveal key={service.title} delay={index * 100}><ServiceCard {...service} /></ScrollReveal>)}</div>
